...
class TestObservableSingleValue(unittest.TestCase):
    ...
    def test_initialization_with_carries_bindable_single_value_binding_consistency(self):
        ...
        self.assertTrue(target._get_single_value_binding_handler().is_bound_to(source._get_single_value_binding_handler()))
        self.assertTrue(source._get_single_value_binding_handler().is_bound_to(target._get_single_value_binding_handler()))
...
class TestObservableSet(unittest.TestCase):
    ...
    def test_initialization_with_carries_bindable_set_binding_consistency(self):
        ...
        # Check that they are properly bound
        self.assertTrue(target._get_set_binding_handler().is_bound_to(source._get_set_binding_handler()))
        self.assertTrue(source._get_set_binding_handler().is_bound_to(target._get_set_binding_handler()))
...
class TestObservableList(unittest.TestCase):
    ...
    def test_initialization_with_carries_bindable_list_binding_consistency(self):
        ...
        # Check that they are properly bound
        self.assertTrue(target._get_list_binding_handler().is_bound_to(source._get_list_binding_handler()))
        self.assertTrue(source._get_list_binding_handler().is_bound_to(target._get_list_binding_handler()))
...
class TestObservableSelectionOption(unittest.TestCase):
    ...
    def test_initialization_with_carries_bindable_binding_consistency(self):
        ...
        # Check that they are properly bound
        self.assertTrue(target._get_set_binding_handler().is_bound_to(source_options._get_set_binding_handler()))
        self.assertTrue(target._get_single_value_binding_handler().is_bound_to(source_selected._get_single_value_binding_handler()))
    ...
    def test_allow_none_binding_behavior(self):
        ...
        obs3.bind_selected_option_to_observable(obs4, SyncMode.UPDATE_VALUE_FROM_OBSERVABLE)
...
class TestObservableMultiSelectionOption(unittest.TestCase):
    ...
    def test_binding_selected_options(self):
        ...
        obs1.bind_selected_options_to_observable(obs2)
    ...
    def test_unbinding(self):
        ...
        obs1.bind_selected_options_to_observable(obs2, SyncMode.UPDATE_VALUE_FROM_OBSERVABLE)
        obs1.unbind_selected_options_from_observable(obs2)
    ...
    def test_unbinding_multiple_times(self):
        ...
        obs1.bind_selected_options_to_observable(obs2, SyncMode.UPDATE_OBSERVABLE_FROM_SELF)
        obs1.unbind_selected_options_from_observable(obs2)
    ...
    def test_binding_to_self(self):
        ...
        with self.assertRaises(ValueError):
            obs.bind_selected_options_to_observable(obs)
    ...
    def test_multiple_bindings(self):
        ...
        # Bind obs2 and obs3 selected options to obs1
        obs2.bind_selected_options_to_observable(obs1)
        obs3.bind_selected_options_to_observable(obs1)
    ...
    def test_initialization_with_carries_bindable_unbinding(self):
        ...
        # Unbind them
        target.unbind_available_options_from_observable(source_available_options)
        target.unbind_selected_options_from_observable(source_selected_options)
    ...
    def test_initialization_with_carries_bindable_binding_consistency(self):
        ...
        # Check that they are properly bound
        self.assertTrue(target._get_available_options_binding_handler().is_bound_to(source_available_options._get_set_binding_handler()))
        self.assertTrue(target._get_selected_options_binding_handler().is_bound_to(source_selected_options._get_set_binding_handler()))
...
class TestObservableDict(unittest.TestCase):
    ...
    def test_initialization_with_carries_bindable_dict_binding_consistency(self):
        ...
        # Check that they are properly bound
        self.assertTrue(target._get_dict_binding_handler().is_bound_to(source._get_dict_binding_handler()))
        self.assertTrue(source._get_dict_binding_handler().is_bound_to(target._get_dict_binding_handler()))
