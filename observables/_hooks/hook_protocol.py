...
@runtime_checkable
class HookProtocol(ListeningProtocol, PublisherProtocol, HasNexusManagerProtocol, Protocol[T]):
    """
    ...
    @final
    @staticmethod
    def submit_values(values: Mapping["HookProtocol[Any]", Any], *, logger: Optional[Logger] = None, raise_submission_error_flag: bool = True) -> tuple[bool, str]:
        """
    ...
    @staticmethod
    @final
    def validate_values(values: Mapping["HookProtocol[Any]", Any], *, logger: Optional[Logger] = None) -> tuple[bool, str]:
        """
