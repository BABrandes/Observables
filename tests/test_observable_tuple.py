...
class TestObservableTuple(unittest.TestCase):
    ...
    def test_initialization_with_carries_bindable_tuple(self):
        ...
        target = ObservableTuple(source.tuple_value_hook)
    ...
    def test_initialization_with_carries_bindable_tuple_chain(self):
        ...
        obs2 = ObservableTuple(obs1.tuple_value_hook)
        obs3 = ObservableTuple(obs2.tuple_value_hook)
    ...
    def test_initialization_with_carries_bindable_tuple_multiple_targets(self):
        ...
        source = ObservableTuple((100,))
        target1 = ObservableTuple(source.tuple_value_hook)
        target2 = ObservableTuple(source.tuple_value_hook)
        target3 = ObservableTuple(source.tuple_value_hook)
    ...
    def test_initialization_with_carries_bindable_tuple_binding_consistency(self):
        ...
        self.assertTrue(target.tuple_value_hook.is_attached_to(source.tuple_value_hook))
        self.assertTrue(source.tuple_value_hook.is_attached_to(target.tuple_value_hook))
    ...
    def test_binding_bidirectional(self):
        ...
        # Bind obs1 to obs2
        obs1.attach(obs2.tuple_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
    ...
    def test_binding_initial_sync_modes(self):
        ...
        obs3.attach(obs4.tuple_value_hook, "value", InitialSyncMode.USE_TARGET_VALUE)
        # Current semantics: target gets caller's value
        self.assertEqual(obs4.tuple_value, (300,))
    ...
    def test_binding_to_self(self):
        ...
        with self.assertRaises(ValueError):
            obs.attach(obs.tuple_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
    ...
    def test_binding_chain_unbinding(self):
        ...
        obs1.attach(obs2.tuple_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
        obs2.attach(obs3.tuple_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
    ...
    def test_multiple_bindings(self):
        ...
        obs2.attach(obs1.tuple_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
        obs3.attach(obs1.tuple_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
    ...
    def test_tuple_binding_edge_cases(self):
        ...
        obs3.attach(obs4.tuple_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
    ...
    def test_tuple_performance(self):
        ...
        for _ in range(100):
            ObservableTuple(source.tuple_value_hook)
...
class TestObservableIntegration(unittest.TestCase):
    ...
    def test_cross_type_binding(self):
        ...
        single_obs.attach(selection_obs.selected_option_hook, "value", InitialSyncMode.USE_CALLER_VALUE) # type: ignore
    ...
    def test_complex_binding_chain(self):
        ...
        # Bind A to B
        obs_a.attach(obs_b.single_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
        # Bind B to C
        obs_b.attach(obs_c.single_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
    ...
    def test_mixed_type_binding_chain(self):
        ...
        selection_obs.attach(set_obs.set_value_hook, "available_options", InitialSyncMode.USE_CALLER_VALUE)
    ...
    def test_multiple_bindings_to_same_target(self):
        ...
        obs1.attach(target.single_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
        obs2.attach(target.single_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
        obs3.attach(target.single_value_hook, "value", InitialSyncMode.USE_CALLER_VALUE)
