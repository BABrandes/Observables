...
class TestObservableSet(unittest.TestCase):
    ...
    def test_initialization_with_carries_bindable_set_edge_cases(self):
        ...
        self.assertEqual(target_none.set_value, {None, 1})
    ...
    def test_none_initialization(self):
        ...
        self.assertIsInstance(obs.set_value, set)
        self.assertEqual(len(obs.set_value), 0)
        
        # Test that we can add items to it
        obs.add(1)
        obs.add(2)
        self.assertEqual(obs.set_value, {1, 2})
    ...
    def test_empty_set_initialization(self):
        ...
        obs.add(10)
        obs.add(20)
        self.assertEqual(obs.set_value, {10, 20})
    ...
    def test_none_vs_empty_set_behavior(self):
        ...
        self.assertEqual(obs_none.set_value, obs_empty.set_value)
        ...
        self.assertEqual(obs_none.set_value, obs_empty.set_value)
        self.assertEqual(obs_none.set_value, {1})
    ...
    def test_binding_empty_set(self):
        ...
        set1.bind_to(set2, SyncMode.UPDATE_SELF_FROM_OBSERVABLE)
        set2.set_value = {4, 5, 6}
        self.assertEqual(set1.set_value, {4, 5, 6})
