...
class ObservableTuple(ComplexObservableBase[Literal["value"], Literal["length"], tuple[T, ...], int, "ObservableTuple"], ObservableTupleProtocol[T], ObservableSerializable[Literal["value"], tuple[T, ...]], Generic[T]):
    ...
    @overload
    def __init__(self, observable_or_hook: Hook[tuple[T, ...]], logger: Optional[Logger] = None) -> None:
    ...
    def __init__(self, observable_or_hook_or_value: tuple[T, ...] | Hook[tuple[T, ...]] | None = None, logger: Optional[Logger] = None) -> None: # type: ignore
        """
    ...
    def __str__(self) -> str:
        ...
        return f"OT(tuple={self._primary_hooks['value'].value})"
    
    def __repr__(self) -> str:
        """Detailed string representation of the observable tuple."""
        return f"ObservableTuple({self._primary_hooks['value'].value})"
