...
from observables._hooks.hook_aliases import Hook
...
class ObservableRaiseNone(CarriesHooksBase[Literal["value_without_none", "value_with_none"], T, "ObservableRaiseNone[T]"], Generic[T]):
    ...
    def __init__(
        self,
        hook_without_None_or_value: Hook[T]|None|T,
        hook_with_None: Hook[Optional[T]]|None = None,
        ...
        if hook_with_None is not None and hook_without_None_or_value is None:
            ...
            if isinstance(hook_without_None_or_value, Hook):
