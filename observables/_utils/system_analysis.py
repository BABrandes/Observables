...
def collect_all_hook_nexuses(dict_of_carries_hooks: dict[str, BaseCarriesHooks[Any, Any]]) -> dict[HookNexus[Any], list[tuple[str, BaseCarriesHooks[Any, Any], HookLike[Any]]]]:
...
def write_report(dict_of_carries_hooks: dict[str, BaseCarriesHooks[Any, Any]]) -> str:
    """
    ...
    for i, (hook_nexus, owner_name_and_hooks) in enumerate(sorted_nexuses, 1):
        ...
        observable_groups: dict[str, list[tuple[BaseCarriesHooks[Any, Any], HookLike[Any]]]] = {}
...
def _get_hook_info(carries_hook: BaseCarriesHooks[Any, Any], hook: HookLike[Any]) -> str:
    """
