...
class TestObservableTransfer(unittest.TestCase):
    ...
    def test_basic_creation(self):
        ...
        self.assertEqual(len(transfer.hooks), 4)  # 2 inputs + 2 outputs
    ...
    def test_attach_detach_hooks(self):
        ...
        # Test attach
        transfer.attach(external_hook, "x", InitialSyncMode.PUSH_TO_TARGET)
        ...
        with self.assertRaises(ValueError):
            transfer.attach(external_hook, "invalid", InitialSyncMode.PUSH_TO_TARGET)
