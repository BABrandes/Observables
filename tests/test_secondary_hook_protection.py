...
class TestSecondaryHookProtection:
    ...
    def test_length_updates_when_list_changes(self):
        ...
        # Track changes
        changes: list[int] = []
        length_observer.add_listeners(lambda: changes.append(length_observer.value))
    ...
    def test_correct_secondary_value_submission_allowed(self):
        ...
        success, msg = obs_list.submit_values({"value": [1, 2], "length": 2})
    ...
    def test_secondary_value_equality_check_uses_nexus_manager(self):
        ...
        success, msg = obs_list.submit_values({"length": 3})
    ...
    def test_secondary_hook_listener_notifications(self):
        ...
        obs_list.length_hook.add_listeners(lambda: length_changes.append(obs_list.length))
    ...
    def test_empty_list_secondary_value_protection(self):
        ...
        success, _ = obs_list.submit_values({"length": 0})
        assert success
